...
class MP {
    ...
    /**
     * Search withdrawals according to filters, with pagination
     * @param array $filters
     * @return array(json)
     */
    public function search_withdrawals($filters) {
        $accessToken = $this->get_access_token();
        ...
        $collectionResult = MPRestClient::get($uriPrefix."/withdrawals/search?" . $filters . "&access_token=" . $accessToken);
        return $collectionResult;
    }
     ...
     * @return array(json)
     */
    public function invisible($preference) {
        $accessToken = $this->get_access_token();

        $preferenceResult = MPRestClient::post("/checkout/custom/create_payment?access_token=" . $accessToken, $preference);
        return $preferenceResult;
    }
    
     public function boleto_preference($preference) {
        $accessToken = $this->get_access_token();
