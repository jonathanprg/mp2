...
<html>
  ...
  <form action="response.php" method="post" id="form-pagar-mp">
    ...
    <p>Código de segurança: <input data-checkout="securityCode" type="text" value="100" /></p>
    <p>Mês de vencimento: <input data-checkout="cardExpirationMonth" type="text" value="01"  /></p>
    <p>Ano de vencimento: <input data-checkout="cardExpirationYear" type="text" value="2018" /></p>
    <p>Titular do cartão: <input data-checkout="cardholderName" type="text" value="VICTOR VASCONCELLOS" /></p>
    <p>Número do documento: <input data-checkout="docNumber" type="text" value="" /></p>
  ...
  <script type="text/javascript">
    Checkout.setPublishableKey("APP_USR-596d5be0-0aae-44fe-aadf-64412d5e2941");
    
    $(document).ready(function() {
    $("#amount").val(Math.floor(Math.random() * 15) + 10)
    });
