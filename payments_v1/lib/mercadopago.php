...
class MPRestClient {
    ...
    private static function get_connect($uri, $method, $content_type) {
        ...
        curl_setopt($connect, CURLOPT_HTTPHEADER, array("Accept: application/json", "Content-Type: " . $content_type , "X-Device-Session-Id:13f89f91-3bcc-a58e-0777-ecae48d1b0eb"));
    ...
    private static function exec($method, $uri, $data, $content_type) {
        ...
        echo '<br><br><b>CURLINFO_TOTAL_TIME : ' . curl_getinfo($connect, CURLINFO_TOTAL_TIME) . "</b>";
        echo '<br><br>CURLINFO_CONNECT_TIME : ' . curl_getinfo($connect, CURLINFO_CONNECT_TIME);
        echo '<br><br>CURLINFO_NAMELOOKUP_TIME : ' . curl_getinfo($connect, CURLINFO_NAMELOOKUP_TIME);
        echo '<br><br>CURLINFO_PRETRANSFER_TIME : ' . curl_getinfo($connect, CURLINFO_PRETRANSFER_TIME);
        echo '<br><br>CURLINFO_STARTTRANSFER_TIME : ' . curl_getinfo($connect, CURLINFO_STARTTRANSFER_TIME);
